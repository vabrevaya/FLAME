...
class FLAME(nn.Module):
    ...
    def __init__(self, config):
        ...
        # load 
        model_path = config.flame_model_path
        ...
        self.register_buffer('lmk_faces_idx', torch.LongTensor(lmk_embeddings['static_lmk_faces_idx']))
        self.register_buffer('lmk_bary_coords', torch.Tensor(lmk_embeddings['static_lmk_bary_coords']).type(self.dtype))
        self.register_buffer('dynamic_lmk_faces_idx', torch.LongTensor(lmk_embeddings['dynamic_lmk_faces_idx']))
        self.register_buffer('dynamic_lmk_bary_coords', torch.Tensor(lmk_embeddings['dynamic_lmk_bary_coords']).type(self.dtype))
        self.register_buffer('full_lmk_faces_idx', torch.LongTensor(lmk_embeddings['full_lmk_faces_idx']))
        self.register_buffer('full_lmk_bary_coords', torch.Tensor(lmk_embeddings['full_lmk_bary_coords']).type(self.dtype))
